          ...
          <div className="flex-1">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed max-w-2xl">
                IT professional specializing in cloud infrastructure, system
                automation, and scalable solutions. With years of experience in
                troubleshooting and system administration, I still approach each
